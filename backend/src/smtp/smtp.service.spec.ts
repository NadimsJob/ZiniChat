  ...
  describe('Dynamic Email Templates', () => {
    ...
    it('triggerWelcomeEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Hello TestBiz, welcome!')
      }), expect.any(Object));
    });
    ...
    it('triggerPaymentSubmittedEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Amount: 1000')
      }), expect.any(Object));
    });
    ...
    it('triggerPaymentPendingAdminEmail should email admins', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        subject: 'Admin Alert',
        plainText: expect.stringContaining('Admin Body')
      }), expect.any(Object));
    });
    ...
    it('triggerPaymentApprovedEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Plan: Premium Plan')
      }), expect.any(Object));
    });
    ...
    it('triggerAddonPurchasedEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Addon: Storage 1GB')
      }), expect.any(Object));
    });
    ...
    it('triggerExpiryReminderEmail (7 days) should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        subject: '7 days left',
        plainText: expect.stringContaining('Expire 7 days')
      }), expect.any(Object));
    });
    ...
    it('triggerExpiryReminderEmail (2 days) should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        subject: '2 days left',
        plainText: expect.stringContaining('Expire 2 days')
      }), expect.any(Object));
    });
    ...
    it('triggerAgentCreatedEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Pass: password123')
      }), expect.any(Object));
    });
    ...
    it('triggerNewInquiryEmail should replace placeholders and email admins', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Msg: Hello there')
      }), expect.any(Object));
    });
    ...
    it('triggerTicketCreatedEmail should replace placeholders and email admins', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Prio: High')
      }), expect.any(Object));
    });
    ...
    it('triggerTicketRepliedEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Msg: We fixed it')
      }), expect.any(Object));
    });
    ...
    it('triggerTicketStatusEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Stat: Closed')
      }), expect.any(Object));
    });
    ...
    it('triggerTicketAssignedEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('To: Admin Mark')
      }), expect.any(Object));
    });
    ...
    it('triggerBroadcastCompletedEmail should replace placeholders', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('Hello TestBiz, your broadcast Promo2027 is done!')
      }), expect.any(Object));
    });
  });
  ...
  describe('Fallback mechanisms', () => {
    ...
    it('should fall back to defaults if custom subject/body is missing', async () => {
      ...
      expect(mockEmailQueue.add).toHaveBeenCalledWith('send-email', expect.objectContaining({
        ...
        plainText: expect.stringContaining('প্রিয় John Doe')
      }), expect.any(Object));
    });
  });
});
