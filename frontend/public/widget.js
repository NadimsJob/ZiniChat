(function () {
  ...
  function injectStyles() {
    ...
    style.innerHTML = 
      ...
      '}\n' +
      '#zc-livechat-container > * { pointer-events: auto !important; }\n' +
      '#zc-livechat-btn {\n' +
  ...
  function initLiveChatWidget(config) {
    ...
    container.style.cssText = 'position:fixed; z-index:999999; bottom:20px; font-family:system-ui,-apple-system,sans-serif; display:flex; flex-direction:column; align-items:flex-end; pointer-events:none;' +
  ...
  function initWidget(config) {
    if (config && config.type === 'WHATSAPP') {
      ...
      var container = document.createElement('div');
      container.style.cssText = 'position:fixed; z-index:999999; bottom:20px;' + (pos === 'bottom-left' ? 'left:20px; right:auto;' : 'right:20px; left:auto;');
