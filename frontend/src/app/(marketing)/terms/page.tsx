...
export default function TermsPage() {
  ...
  const content = language === 'en' 
    ? config?.termsConditionsJson?.en 
    : (config?.termsConditionsJson?.bn || config?.termsConditionsJson?.en);
      ...
      <section className="relative w-full overflow-hidden py-16 px-4 text-center lg:py-20">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mb-12 max-w-2xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
            {language === 'en' 
              ? 'Please read our terms and conditions carefully before using ZiniChat.' 
              : 'ZiniChat ব্যবহার করার আগে অনুগ্রহ করে আমাদের শর্তাবলী সাবধানে পড়ুন।'}
          </p>
        </div>
      </section>
