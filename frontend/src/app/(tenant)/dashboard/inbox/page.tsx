...
export default function InboxPage() {
 ...
 <select value={editDetails.stageId} onChange={(e) => setEditDetails({...editDetails, stageId: e.target.value})} className="w-full bg-surface border border-slate-200 rounded-md py-1 px-1.5 text-[11px] focus:ring-1 focus:ring-primary focus:outline-none">
 ...
 <input type="text" value={editDetails.phone} onChange={(e) => setEditDetails({...editDetails, phone: e.target.value})} placeholder="+123456789" className="w-full bg-surface border border-slate-200 rounded-md py-1 px-1.5 text-[11px] focus:ring-1 focus:ring-primary focus:outline-none text-foreground" />
 </div>
 <div>
 ...
 <input type="email" value={editDetails.email} onChange={(e) => setEditDetails({...editDetails, email: e.target.value})} placeholder="email@example.com" className="w-full bg-surface border border-slate-200 rounded-md py-1 px-1.5 text-[11px] focus:ring-1 focus:ring-primary focus:outline-none text-foreground" />
 </div>
 <div>
 ...
 <input type="text" value={editDetails.company} onChange={(e) => setEditDetails({...editDetails, company: e.target.value})} placeholder="Company Ltd." className="w-full bg-surface border border-slate-200 rounded-md py-1 px-1.5 text-[11px] focus:ring-1 focus:ring-primary focus:outline-none text-foreground" />
 </div>
 <div>
 ...
 <input type="text" value={editDetails.address} onChange={(e) => setEditDetails({...editDetails, address: e.target.value})} placeholder="Full Address..." className="w-full bg-surface border border-slate-200 rounded-md py-1 px-1.5 text-[11px] focus:ring-1 focus:ring-primary focus:outline-none text-foreground" />
 </div>
 </div>
 ...
 <textarea value={noteContent} onChange={(e) => setNoteContent(e.target.value)} placeholder="Type a note..." className="w-full bg-surface border border-slate-200 rounded-lg p-2 text-[11px] focus:ring-1 focus:ring-primary focus:outline-none min-h-[60px] resize-none pb-7" />
