    ...
    <div className="max-w-6xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-surface/70 backdrop-blur-xl p-6 rounded-2xl border border-border">
        ...
        <button
          ...
          className="self-start md:self-auto px-4 py-2 bg-slate-100 dark:bg-zinc-800/80 hover:bg-slate-200 dark:hover:bg-zinc-700/80 rounded-xl text-[12px] font-semibold flex items-center gap-2 transition-all border border-border"
        >
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[12px]">
              <thead className="bg-slate-50 dark:bg-zinc-900/80 border-b border-border text-muted-foreground font-semibold uppercase text-[10px] tracking-wider">
                <tr>
