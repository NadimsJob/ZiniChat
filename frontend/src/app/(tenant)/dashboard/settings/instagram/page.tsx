...
export default function InstagramSettingsPage() {
 ...
 className="flex items-center justify-center gap-2 px-1.5 py-2 text-[13px] text-red-600 hover:bg-red-50 :bg-red-500/10 rounded-lg transition-colors border border-transparent hover:border-red-200 :border-red-500/20"
 >
 ...
 : 'text-slate-500 hover:text-pink-600 :text-pink-400'
 }`}
 >
 ...
 <label className="text-[13px] font-medium text-slate-700 ">Instagram Account ID</label>
 <input 
 type="text" 
 ...
 className="w-full px-1.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none transition-all "
 />
 </div>
 
 <div className="space-y-1.5">
 <label className="text-[13px] font-medium text-slate-700 ">Page Access Token</label>
 <input 
 type="text" 
 ...
 <div className="space-y-1.5">
 <label className="text-[13px] font-medium text-slate-700 ">Verify Token (Optional)</label>
 <input 
 type="text" 
