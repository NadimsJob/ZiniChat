...
export default function MessengerSettingsPage() {
 ...
 <label className="text-[13px] font-medium text-slate-700 ">Page ID</label>
 <input 
 type="text" 
 ...
 className="w-full px-1.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all "
 />
 </div>
