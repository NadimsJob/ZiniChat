...
const FEATURE_MAP: Record<string, { en: string; bn: string; icon: any }> = {
  ...
  'ai_tool_support_detection':       { en: 'AI Tool: Support Detection',           bn: 'এআই টুল: সাপোর্ট ডিটেকশন',        icon: Zap },
  'ai_tool_product_matching':        { en: 'AI Tool: Product Photo Matching',      bn: 'এআই টুল: প্রোডাক্ট ফটো ম্যাচিং', icon: Zap },
