...
export default function SubscriptionSettingsPage() {
 ...
 {/* Currency Toggle */}
 <div className="bg-surface border border-zinc-200 rounded-xl p-1 flex">
 <button
 ...
 >
 Yearly {maxDiscountPercent > 0 && <span className="text-[10px] bg-green-500/20 text-green-600 px-1.5 py-0.5 rounded-full font-bold">Save {formatNumber(maxDiscountPercent)}%</span>}
 </button>
 </div>
 </div>
 </div>
 ...
 className="flex-1 bg-surface border border-zinc-200 rounded-lg px-3 py-2 text-[13px] focus:outline-none focus:border-primary"
 />
 <button 
