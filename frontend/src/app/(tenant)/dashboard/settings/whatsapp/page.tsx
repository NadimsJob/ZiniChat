...
export default function WhatsAppSettingsPage() {
 ...
 return (
 <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl p-1.5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] _8px_30px_rgb(0,0,0,0.2)] max-w-6xl mx-auto space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
 ...
 <div className="p-1.5 border-b border-slate-200 flex justify-between items-center">
 ...
 <button onClick={fetchConnections} className="p-2 hover:bg-slate-100 :bg-zinc-800 rounded-lg text-slate-500 transition-colors">
 ...
 <div key={conn.id} className="p-1.5 flex flex-col sm:flex-row sm:items-center justify-between gap-2 hover:bg-slate-50/50 :bg-zinc-900/50 transition-colors">
 <div>
 ...
 <div className="flex flex-col gap-1 mt-2 text-[13px] text-slate-500 ">
 ...
 conn.isAiAutoReplyEnabled ? 'bg-green-500' : 'bg-slate-300 '
 }`}
 >
 <span
 ...
 className="p-1.5 text-slate-400 hover:text-slate-600 :text-zinc-300 hover:bg-slate-100 :bg-zinc-800 rounded-lg transition-colors"
 >
 ...
 className="p-1.5 text-blue-400 hover:text-blue-600 :text-blue-400 hover:bg-blue-50 :bg-blue-500/10 rounded-lg transition-colors"
 >
 ...
 className="p-1.5 text-red-400 hover:text-red-600 :text-red-400 hover:bg-red-50 :bg-red-500/10 rounded-lg transition-colors"
 >
 ...
 <div className="flex flex-wrap bg-slate-100 p-1 rounded-xl mb-3 gap-1">
 <button
 onClick={() => setActiveTab('embedded')}
 className={`flex-1 min-w-[70px] py-1.5 text-[11px] font-medium rounded-lg transition-colors ${
 activeTab === 'embedded'
 ? 'bg-white shadow-sm text-blue-600 '
 : 'text-slate-500 hover:text-blue-600 :text-blue-400'
 }`}
 >
 FB Login
 </button>
 ...
 : 'text-slate-500 hover:text-slate-700 :text-zinc-200'
 }`}
 >
 Manual
 </button>
 ...
 : 'text-slate-500 hover:text-green-600 :text-green-400'
 }`}
 >
 Web (QR)
 </button>
 ...
 : 'text-slate-500 hover:text-purple-600 :text-purple-400'
 }`}
 >
 Widget
 </button>
 ...
 <div className="p-1.5 bg-amber-50 border border-amber-200 rounded-xl">
 ...
 <div className="space-y-3">
 {error && (
 <div className="p-1.5 bg-red-50 text-red-600 text-[13px] rounded-xl border border-red-200 flex items-start gap-1.5">
 <AlertCircle className="w-5 h-5 flex-shrink-0" />
 <p>{error}</p>
 </div>
 )}
 {successMessage && (
 <div className="p-1.5 bg-emerald-50 text-emerald-600 text-[13px] rounded-xl border border-emerald-200 flex items-start gap-1.5">
 ...
 {activeTab === 'embedded' ? (
 <div className="flex flex-col items-center justify-center py-8 text-center space-y-4 bg-slate-50 rounded-xl border border-slate-200 ">
 ...
 <p className="text-[12px] text-slate-500 max-w-[250px] mx-auto">
 {language === 'en' 
 ...
 className="w-full px-1.5 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all text-[13px]"
 />
 </div>
 <div className="space-y-1">
 <label className="text-[13px] font-medium text-slate-700 ">Phone Number ID <span className="text-red-500">*</span></label>
 <input 
 type="text" 
 value={formData.phoneNumberId}
 onChange={e => setFormData({...formData, phoneNumberId: e.target.value})}
 required
 className="w-full px-1.5 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all text-[13px] font-mono"
 />
 </div>
 <div className="space-y-1">
 <label className="text-[13px] font-medium text-slate-700 ">WABA ID <span className="text-red-500">*</span></label>
 <input 
 type="text" 
 ...
 <div className="space-y-1">
 <label className="text-[13px] font-medium text-slate-700 ">System User Access Token <span className="text-red-500">*</span></label>
 <input 
 type="password" 
 ...
 <div className="flex flex-col items-center justify-center py-8 text-center space-y-3 bg-slate-50 rounded-xl border border-dashed border-slate-300 ">
 <div className="w-12 h-12 bg-slate-200 text-slate-400 rounded-2xl flex items-center justify-center mb-1">
