...
| :--- | :--- | :--- | :--- |
| **2026-09-14** | **Custom WhatsApp Floating Button & Superadmin Settings Engine** | `WhatsAppFloatButton.tsx`, `sp@dmin/settings/whatsapp-widget/page.tsx`, `layout.tsx`, `ClientLayout.tsx`, `landing-page.controller.ts`, `landing-page.service.ts`, `schema.prisma` | Removed old external `widget.js` script from `layout.tsx`. Implemented custom site-wide floating WhatsApp button with direct `https://wa.me/<number>` redirection, default vector icon, pulse ring animation, and bilingual hover tooltips. Created Superadmin WhatsApp Widget settings page (`/sp@dmin/settings/whatsapp-widget`) supporting phone number formatting, color picker, prefilled message text, screen position, and custom icon file upload endpoint (`/landing-page/upload-widget-icon`). |
