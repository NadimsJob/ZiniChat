...
async function run() {
  ...
  const compareFeatures = [
    ...
    { type: "boolean", featureKey: "whatsapp_qr", en: "WhatsApp Web (QR)", bn: "হোয়াটসঅ্যাপ ওয়েব (কিউআর)" },
    { type: "boolean", featureKey: "website_widget", en: "Website Widget", bn: "ওয়েবসাইট উইজেট" },
    { type: "boolean", featureKey: "whatsapp", en: "Official WhatsApp API", bn: "অফিসিয়াল হোয়াটসঅ্যাপ এপিআই" },
    { type: "boolean", featureKey: "messenger", en: "Meta Messenger", bn: "মেটা মেসেঞ্জার" },
    { type: "boolean", featureKey: "instagram_dm", en: "Instagram DM", bn: "ইন্সটাগ্রাম ডিএম" },
    ...
    { type: "boolean", featureKey: "team_management", en: "Team Members & Roles", bn: "টিম মেম্বার ও রোলস" },
    ...
    { type: "boolean", featureKey: "allowByok", en: "Bring Your Own Key (BYOK)", bn: "নিজের এপিআই কী (BYOK)" },
